      ...
      <main className="home-page">
        <Hero className="home-hero">
          ...
          <div className="wrap home-hero__grid">
            ...
            <ScrollReveal className="home-hero__visual" delay={120} variant="scale">
        ...
        <section className="section home-about surface-paper">
          <div className="wrap home-about__grid">
            <ScrollReveal className="home-about__copy">
              <SectionHeader
            ...
            <ScrollReveal className="home-about__photo" delay={100} variant="scale">
        ...
        <section className="section feature-section">
          <div className="wrap feature-grid">
            <ScrollReveal className="feature-section__copy">
              <SectionHeader
                eyebrow="Formação"
                title={
                  <>
            ...
            <ScrollReveal className="feature-section__visual" delay={100} variant="scale">
        ...
        <section className="section ata-section surface-cream">
          <div className="wrap ata-grid">
            ...
            <ScrollReveal className="before-after" delay={110} variant="scale">
              <div>
                <small>Antes</small>
                <ul>
        ...
        <section className="section impact-section">
          <div className="wrap impact-grid">
            ...
            <ScrollReveal className="collage" delay={110} variant="scale">
